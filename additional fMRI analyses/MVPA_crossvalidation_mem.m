...
databasedir = '/media/tw260/Samsung_T5/fMRI/decodCC.01_BIDS/l1output-mem';
...
try
    ...
    elseif strcmp(cfg.analysis,'searchlight')==1
        cfg.files.mask = fullfile('/media/tw260/Samsung_T5/fMRI/results/SecondLevel-stroop/SecondLevel_inc-vs-con/spmT_0002.nii');
    end
catch
...
for sub = 1:length(subdirs)
    ...
    conditions={'easy-con-correct','easy-inc-correct','hard-con-correct','hard-inc-correct'};
    ...
    if strcmp(cfg.analysis,'roi')==1
        cfg.results.dir = fullfile('/media/tw260/Samsung_T5/fMRI/results/mvpa_analysis', 'mem', subdirs{sub},'ROI_crossvalidation');
    elseif strcmp(cfg.analysis,'searchlight')==1
        cfg.results.dir = fullfile('/media/tw260/Samsung_T5/fMRI/results/mvpa_analysis', 'mem', subdirs{sub},'Searchlight_crossvalidation');
    end
